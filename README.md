...
[![PyPI version](<https://img.shields.io/pypi/v/magebank.svg?label=pypi%20(stable)>)](https://pypi.org/project/magebank/)
...
```sh
# install from PyPI
pip install --pre magebank[aiohttp]
```
...
import os
import asyncio
from magebank import DefaultAioHttpClient
from magebank import AsyncMagebank
