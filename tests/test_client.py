...
from magebank._exceptions import MagebankError, APIStatusError, APITimeoutError, APIResponseValidationError
...
def _get_open_connections(client: Magebank | AsyncMagebank) -> int:
...
class TestMagebank:
    client = Magebank(base_url=base_url, bearer_token=bearer_token, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "magebank/_legacy_response.py",
                        "magebank/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MagebankError):
            with update_env(**{"MAGEBANK_API_KEY": Omit()}):
                client2 = Magebank(
                    base_url=base_url, bearer_token=bearer_token, api_key=None, _strict_response_validation=True
                )
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Magebank) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MAGEBANK_BASE_URL="http://localhost:5000/from/env"):
            client = Magebank(bearer_token=bearer_token, api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Magebank) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Magebank) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Magebank) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/agentsWith/agent_k77NTwxp2Ym3JCmVsKtXQA").mock(side_effect=retry_handler)

        response = client.agents_with.with_raw_response.retrieve("id")
    ...
    def test_omit_retry_count_header(
        self, client: Magebank, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.agents_with.with_raw_response.retrieve("id", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncMagebank:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMagebank) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MAGEBANK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMagebank(bearer_token=bearer_token, api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMagebank) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMagebank) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMagebank) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        ...
        response = await client.agents_with.with_raw_response.retrieve("id")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMagebank, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.agents_with.with_raw_response.retrieve(
            "id", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from magebank._utils import asyncify
        from magebank._base_client import get_platform
